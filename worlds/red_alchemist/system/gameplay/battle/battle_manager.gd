...
const Order = preload("res://worlds/red_alchemist/system/gameplay/battle/exchange_order.gd")
const Resolver = preload("res://worlds/red_alchemist/system/gameplay/battle/attack_resolver.gd")
var targeting := Targeting.new()
var rules := Rules.new()
var order := Order.new()
var resolver := Resolver.new()
const XpManager = preload("res://worlds/red_alchemist/system/gameplay/progression/xp_manager.gd")
