...
const Shake = preload("res://worlds/red_alchemist/system/animation/effects/damage_shake.gd")
const Glow = preload("res://worlds/red_alchemist/system/animation/effects/damage_glow.gd")
const Evade = preload("res://worlds/red_alchemist/system/animation/effects/evade.gd")
const Block = preload("res://worlds/red_alchemist/system/animation/effects/block.gd")
const Overpower = preload("res://worlds/red_alchemist/system/animation/effects/overpower.gd")
const Strike = preload("res://worlds/red_alchemist/system/animation/effects/strike.gd")
const Movement = preload("res://worlds/red_alchemist/system/animation/effects/movement.gd")
